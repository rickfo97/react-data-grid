...
const cell = "c1wupbe7-0-0-beta-27";
const cellClassname = `rdg-cell ${cell}`;
const cellFrozen = "cd0kgiy7-0-0-beta-27";
const cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
const cellFrozenLast = "c1730fa47-0-0-beta-27";
const cellFrozenLastClassname = `rdg-cell-frozen-last ${cellFrozenLast}`;

const root = "r104f42s7-0-0-beta-27";
const rootClassname = `rdg ${root}`;
const viewportDragging = "v7ly7s7-0-0-beta-27";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
const focusSinkClassname = "fc4f4zb7-0-0-beta-27";

const row = "r1otpg647-0-0-beta-27";
const rowClassname = `rdg-row ${row}`;
const rowSelected = "rel5gk27-0-0-beta-27";
const rowSelectedClassname = 'rdg-row-selected';
const rowSelectedWithFrozenCell = "r1qymf1z7-0-0-beta-27";

const checkboxLabel = "c8rwwhf7-0-0-beta-27";
const checkboxLabelClassname = `rdg-checkbox-label ${checkboxLabel}`;
const checkboxInput = "c1rb4brs7-0-0-beta-27";
const checkboxInputClassname = `rdg-checkbox-input ${checkboxInput}`;
const checkbox = "c1bvvwcc7-0-0-beta-27";
const checkboxClassname = `rdg-checkbox ${checkbox}`;
const checkboxLabelDisabled = "c1yg790j7-0-0-beta-27";
...
const groupCellContent = "gb8l2vs7-0-0-beta-27";
const groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
const caret = "c1ggynjl7-0-0-beta-27";
...
const measuringCellClassname = "m1l09lto7-0-0-beta-27";
...
function useCalculatedColumns({
  ...
  var _defaultColumnOptions, _defaultColumnOptions2, _defaultColumnOptions3, _defaultColumnOptions4, _defaultColumnOptions5, _defaultColumnOptions6;
  ...
  const defaultFormatter = (_defaultColumnOptions4 = defaultColumnOptions === null || defaultColumnOptions === void 0 ? void 0 : defaultColumnOptions.formatter) !== null && _defaultColumnOptions4 !== void 0 ? _defaultColumnOptions4 : valueFormatter;
...
function useRovingCellRef(isSelected, skipCellFocusRef) {
  ...
  const ref = react.useCallback(cell => {
    if (cell === null) return;
    if (skipCellFocusRef !== null && skipCellFocusRef !== void 0 && skipCellFocusRef.current) {
...
const headerSortCell = "h1e8ezgp7-0-0-beta-27";
const headerSortCellClassname = `rdg-header-sort-cell ${headerSortCell}`;
const headerSortName = "h1rrblhe7-0-0-beta-27";
...
const cellResizable = "celq7o97-0-0-beta-27";
...
function HeaderCell({
  ...
  const headerRenderer$1 = (_column$headerRendere = column.headerRenderer) !== null && _column$headerRendere !== void 0 ? _column$headerRendere : headerRenderer;
...
const headerRow = "h197vzie7-0-0-beta-27";
...
const cellCopied = "ccpfvsn7-0-0-beta-27";
const cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
const cellDraggedOver = "c1bmg16t7-0-0-beta-27";
...
function Row({
  ...
  className = clsx(rowClassname, `rdg-row-${rowIdx % 2 === 0 ? 'even' : 'odd'}`, rowClass === null || rowClass === void 0 ? void 0 : rowClass(row), className, isChildRow && "rdg-child-row", selectedCellIdx === -1 && rowSelectedClassname);
  const cells = [];
...
function GroupCell({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    onFocus: onFocus,
    children: (!column.rowGroup || groupColumnIndex === column.idx) && ((_column$groupFormatte = column.groupFormatter) === null || _column$groupFormatte === void 0 ? void 0 : _column$groupFormatte.call(column, {
      groupKey,
      childRows,
      column,
      row,
...
const groupRow = "gyxx7e97-0-0-beta-27";
...
function GroupedRow({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(RowSelectionProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      className: clsx(rowClassname, groupRowClassname, `rdg-row-${rowIdx % 2 === 0 ? 'even' : 'odd'}`, childRows.length > 1 && 'rdg-group-row-has-children', selectedCellIdx === -1 && rowSelectedClassname),
...
const summaryCellClassname = "s1n3hxke7-0-0-beta-27";
function SummaryCell({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    onClick: onClick,
    onFocus: onFocus,
    children: (_column$summaryFormat = column.summaryFormatter) === null || _column$summaryFormat === void 0 ? void 0 : _column$summaryFormat.call(column, {
      column,
      row,
      isCellSelected
    })
...
const summaryRow = "snfqesz7-0-0-beta-27";
const topSummaryRow = "t1jijrjz7-0-0-beta-27";
const topSummaryRowBorderClassname = "t14bmecc7-0-0-beta-27";
const bottomSummaryRowBorderClassname = "b1odhhml7-0-0-beta-27";
...
const cellEditing = "c1tngyp17-0-0-beta-27";
function EditCell({
  column,
  colSpan,
  row,
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: column.editor != null && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [column.editor({
        ...
        onRowChange,
        onClose
      }), ((_column$editorOptions3 = column.editorOptions) === null || _column$editorOptions3 === void 0 ? void 0 : _column$editorOptions3.renderFormatter) && column.formatter({
        column,
        row,
        isCellSelected: true,
        onRowChange
...
const cellDragHandle = "cadd3bp7-0-0-beta-27";
...
const arrow = "a1mygwml7-0-0-beta-27";
...
function DataGrid(props, ref) {
  var _ref, _renderers$rowRendere, _ref2, _renderers$sortStatus, _ref3, _renderers$checkboxFo, _renderers$noRowsFall, _topSummaryRows$lengt, _bottomSummaryRows$le;
  const {
    columns: rawColumns,
    rows: rawRows,
    topSummaryRows,
  ...
  const rowRenderer = (_ref = (_renderers$rowRendere = renderers === null || renderers === void 0 ? void 0 : renderers.rowRenderer) !== null && _renderers$rowRendere !== void 0 ? _renderers$rowRendere : defaultRenderers === null || defaultRenderers === void 0 ? void 0 : defaultRenderers.rowRenderer) !== null && _ref !== void 0 ? _ref : defaultRowRenderer;
  const sortStatus$1 = (_ref2 = (_renderers$sortStatus = renderers === null || renderers === void 0 ? void 0 : renderers.sortStatus) !== null && _renderers$sortStatus !== void 0 ? _renderers$sortStatus : defaultRenderers === null || defaultRenderers === void 0 ? void 0 : defaultRenderers.sortStatus) !== null && _ref2 !== void 0 ? _ref2 : sortStatus;
  const checkboxFormatter$1 = (_ref3 = (_renderers$checkboxFo = renderers === null || renderers === void 0 ? void 0 : renderers.checkboxFormatter) !== null && _renderers$checkboxFo !== void 0 ? _renderers$checkboxFo : defaultRenderers === null || defaultRenderers === void 0 ? void 0 : defaultRenderers.checkboxFormatter) !== null && _ref3 !== void 0 ? _ref3 : checkboxFormatter;
  const noRowsFallback = (_renderers$noRowsFall = renderers === null || renderers === void 0 ? void 0 : renderers.noRowsFallback) !== null && _renderers$noRowsFall !== void 0 ? _renderers$noRowsFall : defaultRenderers === null || defaultRenderers === void 0 ? void 0 : defaultRenderers.noRowsFallback;
  ...
  function selectCell(position, enableEditor) {
    ...
    if (enableEditor && isCellEditable(position)) {
      ...
      scrollIntoView((_gridRef$current = gridRef.current) === null || _gridRef$current === void 0 ? void 0 : _gridRef$current.querySelector('[tabindex="0"]'));
    } else {
      setSelectedPosition({
        ...position,
        mode: 'SELECT'
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [hasGroups && /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(RowSelectionChangeProvider, {
        ...
        children: [topSummaryRows === null || topSummaryRows === void 0 ? void 0 : topSummaryRows.map((row, rowIdx) => {
...
const textEditorInternalClassname = "tlmcuo07-0-0-beta-27";
