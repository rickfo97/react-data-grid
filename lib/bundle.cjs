...
const rowSelectedWithFrozenCell = "r1qymf1z700-beta11";

var css_248z$c = ".cd9l4jz700-beta11{align-items:center;cursor:pointer;display:flex;inset:0;justify-content:center;margin-inline-end:1px;position:absolute}.c1noyk41700-beta11{all:unset}.cdwjxv8700-beta11{background-color:var(--rdg-background-color);block-size:20px;border:2px solid var(--rdg-border-color);content:\"\";inline-size:20px}.c1noyk41700-beta11:checked+.cdwjxv8700-beta11{background-color:var(--rdg-checkbox-color);outline:4px solid var(--rdg-background-color);outline-offset:-6px}.c1noyk41700-beta11:focus+.cdwjxv8700-beta11{border-color:var(--rdg-checkbox-focus-color)}.cca4mwn700-beta11{cursor:default}.cca4mwn700-beta11 .cdwjxv8700-beta11{background-color:var(--rdg-checkbox-disabled-background-color);border-color:var(--rdg-checkbox-disabled-border-color)}";
...
function useCalculatedColumns({
  ...
  const defaultWidth = defaultColumnOptions === null || defaultColumnOptions === void 0 ? void 0 : defaultColumnOptions.width;
  const defaultMinWidth = (_defaultColumnOptions = defaultColumnOptions === null || defaultColumnOptions === void 0 ? void 0 : defaultColumnOptions.minWidth) !== null && _defaultColumnOptions !== void 0 ? _defaultColumnOptions : 80;
  const defaultMaxWidth = defaultColumnOptions === null || defaultColumnOptions === void 0 ? void 0 : defaultColumnOptions.maxWidth;
  ...
  }, [columnWidths, columns, viewportWidth, defaultWidth, defaultMinWidth, defaultMaxWidth, lastFrozenColumnIndex]);
...
function getSpecifiedWidth({
  key,
  width
}, columnWidths, viewportWidth, defaultWidth) {
  var _width;
  if (columnWidths.has(key)) {
    return columnWidths.get(key);
  }
  width = (_width = width) !== null && _width !== void 0 ? _width : defaultWidth;
...
function clampColumnWidth(width, {
  ...
  var _maxWidth;
  width = max(width, minWidth !== null && minWidth !== void 0 ? minWidth : defaultMinWidth);
  maxWidth = (_maxWidth = maxWidth) !== null && _maxWidth !== void 0 ? _maxWidth : defaultMaxWidth;
...
function HeaderCell({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    style: {
      ...
      minWidth: (_column$minWidth = column.minWidth) !== null && _column$minWidth !== void 0 ? _column$minWidth : undefined,
      maxWidth: (_column$maxWidth = column.maxWidth) !== null && _column$maxWidth !== void 0 ? _column$maxWidth : undefined
    },
    onFocus: handleFocus,
    onClick: onClick,
...
function DataGrid({
  ...
  const RowRenderer = (_ref = (_components$rowRender = components === null || components === void 0 ? void 0 : components.rowRenderer) !== null && _components$rowRender !== void 0 ? _components$rowRender : defaultComponents === null || defaultComponents === void 0 ? void 0 : defaultComponents.rowRenderer) !== null && _ref !== void 0 ? _ref : Row$1;
  const sortIcon = (_ref2 = (_components$sortIcon = components === null || components === void 0 ? void 0 : components.sortIcon) !== null && _components$sortIcon !== void 0 ? _components$sortIcon : defaultComponents === null || defaultComponents === void 0 ? void 0 : defaultComponents.sortIcon) !== null && _ref2 !== void 0 ? _ref2 : SortIcon;
  const checkboxFormatter = (_ref3 = (_components$checkboxF = components === null || components === void 0 ? void 0 : components.checkboxFormatter) !== null && _components$checkboxF !== void 0 ? _components$checkboxF : defaultComponents === null || defaultComponents === void 0 ? void 0 : defaultComponents.checkboxFormatter) !== null && _ref3 !== void 0 ? _ref3 : CheckboxFormatter;
  const noRowsFallback = (_components$noRowsFal = components === null || components === void 0 ? void 0 : components.noRowsFallback) !== null && _components$noRowsFal !== void 0 ? _components$noRowsFal : defaultComponents === null || defaultComponents === void 0 ? void 0 : defaultComponents.noRowsFallback;
  ...
  (_direction = direction) !== null && _direction !== void 0 ? _direction : direction = 'ltr';
  ...
  useLayoutEffect(() => {
    ...
    onColumnResize === null || onColumnResize === void 0 ? void 0 : onColumnResize(autoResizeColumn.idx, width);
